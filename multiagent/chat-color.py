...
class Agent():
    def __init__(self, agent, logger, prompt, config) -> None:
        ...
        self.api_key = "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"
        self.base_url = "https://gateway.ai.cloudflare.com/v1/20b5f8f6bcbbd1d2e58af811c5ba8824/gpt4o-mini/openai"
...
class Host():
    def __init__(self, name: str, logger, prompt, config, modelname,modelmessage,agents: List[Agent]):
        ...
        self.api_key = "0c75de50975e4f278b882fe90da47f2f"
        self.api_version = '2023-05-15'
        self.azure_endpoint = 'https://ces.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-02-15-preview'
...
def chat(config, prompt):
    ...
    file_handler = logging.FileHandler(config['log_path_color'])
    ...
    with open("D:\\MemeAgent\\VideoEvalAgent\\data\\gpt\\color_multiagent_history_results-test.json", "w") as f:
        json.dump(history, f,indent=4)
    with open("D:\\MemeAgent\\VideoEvalAgent\\data\\gpt\\color_multiagent_updated_description_results-test.json", "w") as f:
        json.dump(des, f,indent=4)
    with open("D:\\MemeAgent\\VideoEvalAgent\\data\\gpt\\color_multiagent_ev_results-test.json", "w") as f:
