...
3.Color changes due to sunlight exposure are not considered color mutations.
4.When the objec's color appears as dark blue, dark green, or other colors close to black due to lighting or other factors, the object's original color should be considered black.
5.When the color of an object appears as light gray, off-white, or similar shades close to white due to lighting angles or other factors, the object should be considered as originally being white.
...
2. Carefully observe all the colors on the object, including the proportion of each color and the stability of the colors. Also describe the colors of the background and their stability. Notice if the object's color blends into the background's color.
3. Give a description of the video based on above observations.
...
2. Focus on whether the object’s color blends into the background's color due to color similarity.
...
2. Does the object's color blend into the background's color due to color similarity?
...
"gpt4o-answer":"""
### Task Description:
You are now a Video Evaluation Expert. Your task is to carefully watch the text prompt and video carefully, describing the color in the video in detail.
including whether the generated object can be recognized, whether the color is correct or similar, whether the colors in the video are stable, how much area the other colors occupy the object, and whether they affect the dominance of the colors in the text prompt, and whether the color of the object blends with the color of the background?
...
2. Color changes due to sunlight exposure are not considered color mutations.
3. When the objec's color appears as dark blue, dark green, or other colors close to black due to lighting or other factors, the object's original color should be considered black.
...
6. Your description must include the content mentioned above.
