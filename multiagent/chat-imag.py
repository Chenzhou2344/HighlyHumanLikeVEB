...
def chat(config, prompt):
    ...
    with open("D:\\MemeAgent\\VideoEvalAgent\\data\\gpt\\imaging_quality_multiagent_history_results.json", "w") as f:
        json.dump(history, f,indent=4)
    with open("D:\\MemeAgent\\VideoEvalAgent\\data\\gpt\\imaging_quality_multiagent_updated_description_results.json", "w") as f:
        json.dump(des, f,indent=4)
    with open("D:\\MemeAgent\\VideoEvalAgent\\data\\gpt\\imaging_quality_multiagent_ev_results.json", "w") as f:
...
if __name__ == '__main__':
    ...
    chat(config, prompt['imaging_quality'])
