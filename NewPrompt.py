...
<instructions>
            ...
            1. You just need to check if all the elements in the text prompt are rendered in the video, and the extra elements in the video do not affect unless the number of objects is wrong
